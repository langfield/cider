...
class Client():
    ...
    def request_for_connection(self, nat_type_id=0):
        ...
        print("DEBUG: self.pool:", self.pool)
    ...
    def recv_msg(self, sock, event=None, is_restrict=False):
        if is_restrict:
            while True:
    ...
    def chat_fullcone(self):
        self.start_working_threads(self.send_msg, self.recv_msg, self.sockfd, event=None, is_restrict=False)
    ...
    def chat_restrict(self):
        ...
        self.start_working_threads(self.send_msg, self.recv_msg, self.sockfd, event=cancel_event, is_restrict=True)
    ...
    def chat_symmetric(self):
        ...
        self.start_working_threads(send_msg_symm, recv_msg_symm, self.sockfd, event=None, is_restrict=False)
